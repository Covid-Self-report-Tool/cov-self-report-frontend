  ...
  return (
    <Container className={`simpler-font ${classes.root}`}>
      ...
      <p>
        ...
        friends, physicists and computer scientists, about the issue. Soon we
        came together as a team and the idea for this open source, open data,
      ...
      <ul>
        <li>
          ...
          passion and expertise range from the film industry, mobile game
          D&amp;D to the food and beverage industry. He helped lead the
          marketing initiatives at Partender, and has been mentor, organizer and
          global ambassador at StartUp Weekend, 3Day Startups and Global
        ...
        <li>
          <strong>Guneeta Singh Bhalla, PhD</strong> has a PhD in physics from
          the University of Florida and completed her post doctoral research at
          the University of California at Berkeley and the Lawrence Berkeley
        ...
        <li>
          ...
          University of Florida, volunteered for the Peace Corps for two years
          in Ghana and currently teaches physics at California Polytechnic State
          University while doing research in mathematical modeling of solid
          state materials. |{' '}
          <a
            target="_blank"
            rel="noopener noreferrer"
        ...
        <li>
          ...
          works on platforms to enable government and citizen interaction easy
          and data driven. |{' '}
          <a
            target="_blank"
            rel="noopener noreferrer"
      ...
      <p>
        <strong>Polsinelli Law Firm</strong> This project is supported through
        the efforts of{' '}
        <a
          target="_blank"
          rel="noopener noreferrer"
